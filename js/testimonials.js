// Fetching testimonials.json data and creating list of testimonials
$(document).ready(function () {
  // fetch
  fetchTestimonialsData().then((testimonials) => {
    // render achievements
    renderAchievements(testimonials.achievements);
    // render testimonials
...
function fetchTestimonialsData() {
  return $.ajax({
    url: "testimonials.json",
    dataType: "json",
  }).fail(function (jqXHR) {
    console.error("Failed to fetch testimonials data. Response: ", jqXHR);
  });
}
